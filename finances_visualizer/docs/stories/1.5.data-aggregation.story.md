...
- Start or End undefined → Return all
- Same day → Include transactions on that day
...
// Single transaction
calculateSummary([oneTransaction]) → Works correctly
...
- Full aggregation pipeline: CSV → categorized → aggregated
